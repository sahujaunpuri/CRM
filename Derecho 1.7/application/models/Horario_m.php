...
class Horario_m extends CI_Model
{
  ...
  {
    $query = $this->db->query("SELECT bloquehorario.IDBLOQUEHO, bloquehorario.SEMESTREGRUPO, bloquehorario.GRUPO, materia.NOMBREMAT, bloquehorario.CORREOPROF, bloquehorario.NUMEROSALON, bloquehorario.DIABLOQUE, bloquehorario.IDMATERIA,bloquehorario.HORASBLOQUE FROM bloquehorario JOIN materia USING (IDMATERIA) ORDER BY semestremat ASC, GRUPO ASC, IDMATERIA ASC ");
    $arra = $query->result();
