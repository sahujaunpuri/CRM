...
<!--                              <th>UOM</th>-->
                              <th style="text-align: right" width="15%">UNIT PRICE(<span class="customer_currency_unit"> SGD </span>)</th>
                        ...
                        <div class="col-md-12 col-xs-12">
                            <div class="table-responsive">
                                ...
                                <table class="table footer">
                                    <tbody>
                                    <tr>
                                        <td colspan="5" style="clear: both"><?php echo $quotation_edit_data->quotation_footer_text; ?>
