    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="col-sm-8 error_block">
          <input class="form-control customercode" name="customer_code" id="customer_code" value="<?php echo $customer->customer_code; ?>"  placeholder="Customer Code" type="text" required="">
          <span class="customer_code_error" style="display: none;">Alert - This Customer Code is not avaliable</span>
        </div>
      </div>
      <div class="form-group">
