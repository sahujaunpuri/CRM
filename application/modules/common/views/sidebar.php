                              ...
                              <ul class="treeview-menu">
                                 ...
                                 <li>
                                    ...
                                    <span>New Payment</span>
                                       ...
                                       <ul class="treeview-menu">
                                          <li>
                                             <a href="<?php echo base_url(); ?>backend/new_payment">
                                             <i class="fa fa-arrow-right"></i>
                                             <span>Payment to Supplier</span>
                                             </a>
                                          </li>
                                          <li>
                                             <a href="<?php echo base_url(); ?>backend/other_payment">
                                             <i class="fa fa-arrow-right"></i>
  ...
  $('.sidebar-menu').find('a').each(function() {
   ...
   function ConfirmDialog(message,mode){
      $.confirm({
          ...
          text: "Please ensure you have backup all your datafiles.<br/> PROCEED WITH ZAP!",
          cancelButton: "No",
