...
<br>
                ...
                <section class="receipt">
                  ...
                  <div class="row receipt-info">
                    <div class="col-sm-4 receipt-col">
                      ...
                      <address>
                        ...
                        <select name="customer_id" class="hidden" id="customer_id"
                                title="Select Customer" class="form-control select2"
                                required="">
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-md-4 product_id_div">
                      <select name="invoice_reference_id" id="invoice_reference_id"
                              title="Select Invoices" class="form-control select2"
                              multiple="multiple">
                  ...
                  <div class="row" align="left">
                    <div class="col-md-12">
                      <div class="display-none receipt_body">Received with thanks the sum of <span
                            id="currency">...</span><span id="inv_amount">...</span> being
                        payment for above invoices with <span id="cn_amount">...</span> Credit
                        Note.
                      </div>
                    </div>
                    <br>
                    <div class="row col-md-12">
                      <div class="col-md-6">Bank: <input type="text" class="form-control"
                                                         name="bank"
                                                         value="<?php echo $receipt_edit_data->bank; ?>" disabled>
                      </div>
                      <div class="col-md-6">Cheque: <input type="text" name="cheque"
                                                           class="form-control"
                                                           value="<?php echo $receipt_edit_data->cheque; ?>" disabled>
                      </div>
                    </div>
                    <br>
                    <br><br>
                    <div class="row col-md-12">
                      ...
                      <div class="col-md-6"><input type="text" name="other_reference"
                                                   class="form-control"
                                                   value="<?php echo $receipt_edit_data->other_reference; ?>" disabled>
                      </div>
                    </div>
                    <!-- /.col -->
                  </div>
  ...
  <script type="text/javascript">
    ...
    var $partial_amount = $(".partial_amount");
    $(function () {
      ...
      if (customer_id !== "") {
        $.post('<?php echo base_url('common/Ajax/receiptlist_ajax/get_customer_details') ?>', {customer_id: customer_id}, function (data) {
      ...
      for (var i = 0; i < invoice_id_arr.length; i++) {
        ...
        $.post('<?php echo base_url('common/Ajax/receiptlist_ajax/get_receipt_edit_data') ?>', {
          ...
          $inv_table.find("tbody").append('<tr id="'
              + pay_invoice_id
              + '"> <td>'
