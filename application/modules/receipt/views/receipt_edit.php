                ...
                <section class="receipt">
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-md-4 product_id_div">
                      <select name="invoice_reference_id" id="invoice_reference_id" title="Select Invoices"
                  ...
                  <div class="row" align="left">
                    <div class="col-md-12">
                      <div class="display-none receipt_body">Received with thanks the sum of <span
                            id="currency">...</span><span id="inv_amount">...</span> being payment for above invoices
                        with <span id="cn_amount">...</span> Credit Note.
                      </div>
                    </div>
                    <br>
                    <div class="row col-md-12">
                      <div class="col-md-6">Bank: <input type="text" class="form-control" name="bank"
                                                         value="<?php echo $receipt_edit_data->bank; ?>"></div>
                      <div class="col-md-6">Cheque: <input type="text" name="cheque" class="form-control"
                                                           value="<?php echo $receipt_edit_data->cheque; ?>"></div>
                    </div>
                    <br>
                    <br><br>
                    <div class="row col-md-12">
                      <div class="col-md-6">OTHER REFERENCE IF ANY:</div>
                      <div class="col-md-6"><input type="text" name="other_reference" class="form-control"
                                                   value="<?php echo $receipt_edit_data->other_reference; ?>"></div>
                    </div>
                    <!-- /.col -->
                  </div>
...
<script type="text/javascript">
  ...
  $(function () {
    var credit_tune = function (change_flag) {
      ...
      var tot_cn = 0;
      var tot_inv = 0;
      var $partial_amoutn = $(".partial_amount");
      var $rec_amount = $("#rec_amount");
      var $inv_amount = $("#inv_amount");
      $partial_amoutn.each(function () {
    ...
    var $invoice_reference_id = $("#invoice_reference_id");
    var $customer_id = $("#customer_id");
    var $customer_cntry_post = $("#customer_cntry_post");
    ...
    var $inv_table_tbody = $("#inv_table").find("tbody");
    $inv_table_tbody.empty();
    $count = 0;
    for (var i = 0; i < invoice_id_arr.length; i++) {
      invoice_id = invoice_id_arr[i];
      $.post('<?php echo base_url('common/Ajax/receiptlist_ajax/get_receipt_edit_data') ?>', {
        invoice_id: invoice_id_arr,
        receipt_id: <?php echo $receipt_edit_data->receipt_id;?>}, function (data, textStatus, xhr) {
        console.log(data);
        obj = $.parseJSON(data);
    ...
    $invoice_reference_id.change(function (event) {
      var invoice_id = [];
      $.each($invoice_reference_id, function () {
