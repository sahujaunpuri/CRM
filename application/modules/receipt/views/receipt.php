                    ...
                    <div class="row receipt-info">
                      <div class="col-sm-4 receipt-col">
                        ...
                        <address>
                          ...
                          <select name="customer_id" id="customer_id" title="Select Customer"
                      ...
                      <div class="col-sm-4 receipt-col">
                        <label for="receipt_ref_no"><b>Receipt
                            : <?php echo $receipt_details->receipt_text_prefix . '.' . $total_receipt; ?></b></label>
                      ...
                      <div class="row col-md-12 display-none" id="bank_input">
                        ...
                        <div class="col-md-4">
                          Amount receipt ( <span class="cheque_currency" id="cheque_currency"></span> ): <input
                              type="number" name="amount" id="amount" class="form-control" min="1">
                        </div>
                        <div id="without_document" class="col-md-4 receipt-col col-md-offset-4"
                        ...
                        <div class="text-center col-md-2 col-md-offset-5 p-b-t-10 display-none" id="request_reference">
                          <div id="answers">
                            <p class="">CONTRA:</p>
                            <button type="button" id="dont_use_reference" class="btn btn-danger ml-10" disabled=""><i
                                  class="fa fa-times"></i> No
                            </button>
                            <button type="button" id="use_reference" class="btn btn-success"><i class="fa fa-check"></i>
                              Yes
                            </button>
                          </div>
                        </div>
                ...
                <div class="receipt invoice">
                  <div class="row receipt-info">
                    <div class="row no-print">
                      <div class="col-md-11">
                        <button type="submit" id="submitbtn" class="btn btn-success pull-right"><i
                              class="fa fa-credit-card"></i> Submit
                        </button>
                        <button type="button" class="btn btn-default btn-danget pull-right display-none" id="abort"
                                style="margin-right: 20px">Abort
                        </button>
                      </div>
                    </div>
                  </div>
...
<script>
  ...
  $(function () {
    ...
    use_reference.click(function (event) {
      ...
      request_reference.remove();
      //if(cheque.val() == ''){
      chequeReference = '<?php echo $receipt_details->receipt_text_prefix . '.' . $total_receipt; ?>';
      //} else {
