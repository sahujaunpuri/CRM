                        ...
                        <tbody>
                          <?php
                            for($i = 0; $i < $row_num; $i ++){
                              ...
                              <tr>
                                <td><?php echo $i + 1; ?></td>
                                <td style="width: 250px;"><span><?php echo $description[$i]; ?></span><br><span><?php echo $detail_description[$i]; ?></span></td>
                                <td ><?php echo $quantity[$i]; ?></td>
                                <td style="max-width: 100px"><?php echo $uom[$i]; ?></td>
                                <td style="text-align: right;"><span style="margin-right: 10px"><?php echo $unit_price[$i]; ?></span></td>
                                <td style="text-align: right;padding-right: 20px"><?php echo $discount[$i]; ?></td>
                    ...
                    <div class="col-md-12 col-xs-12">
                      <div class="table-responsive">
                        ...
                        <table class="table footer">
                            <tbody>
                                <tr>
                                    <td colspan="5"><?php echo $invoice_footer_text;; ?>
