      ...
      for (var i = 0; i < product_id_arr.length; i++) {
        ...
        $.post('<?php echo base_url('common/Ajax/quotationlist_ajax/get_product_row_edit') ?>', {  billing_id: product_id,quotation_id:quotation_id}, function(data, textStatus, xhr) {
          ...
          $("#product_table tbody").append("<tr id=''><td class='sno'>"+(rowCount+1)+"</td>"+data+"</tr>");
            ...
            getDescription('billing_id='+product_id_get+'&invoice_ref_no=<?php echo $invoice_edit_data->invoice_ref_no;?>',product_id_get);
        });
...
$('#btnSaveDescription').click(function() {
    ...
    info = 'billing_id='+product_id_add+'&invoice_ref_no=<?php echo $invoice_edit_data->invoice_ref_no; ?>';
