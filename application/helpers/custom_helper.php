...
if (!function_exists('databaseInitialize')) {
    ...
    {
        $CI =& get_instance();
        if ($CI->db->table_exists('customer_master')) {
            $res[] = $CI->db->truncate('customer_master');
        }
        if ($CI->db->table_exists('billing_master')) {
            $res[] = $CI->db->truncate('billing_master');
        }
        if ($CI->db->table_exists('salesman_master')) {
            $res[] = $CI->db->truncate('salesman_master');
        }
...
if (!function_exists('zapAR')) {
    function zapAR($tables = array())
    {
        ...
        if ($CI->db->table_exists('open_table')) {
            $res[] = $CI->db->truncate('open_table');
        }
...
if (!function_exists('zapStock')) {
    function zapStock($tables = array())
    {
        ...
        if ($CI->db->table_exists('stock_invoice_master')) {
            $res[] = $CI->db->truncate('stock_invoice_master');
        }
        if ($CI->db->table_exists('open_stock_table')) {
            $res[] = $CI->db->truncate('open_stock_table');
        }
        if ($CI->db->table_exists('stock_adjustment_master')) {
            $res[] = $CI->db->truncate('stock_adjustment_master');
        }
        if ($CI->db->table_exists('stock_purchase_master')) {
            $res[] = $CI->db->truncate('stock_purchase_master');
        }
        if (in_array(FALSE, $res)) {
            set_flash_message('message', 'danger', "Something went Wrong");
        } else {
...
if (!function_exists('zapBank')) {
    function zapBank($tables = array())
    {
        ...
        if ($CI->db->table_exists('bank')) {
            $res[] = $CI->db->truncate('bank');
        }
        if ($CI->db->table_exists('bank_adjustment')) {
            $res[] = $CI->db->truncate('bank_adjustment');
        }
        if (in_array(FALSE, $res)) {
            set_flash_message('message', 'danger', "Something went Wrong");
        } else {
...
if (!function_exists('zapOPayment')) {
    function zapOPayment($tables = array())
    {
        ...
        if ($CI->db->table_exists('other_payment')) {
            $res[] = $CI->db->truncate('other_payment');
        }
        if (in_array(FALSE, $res)) {
            set_flash_message('message', 'danger', "Something went Wrong");
        } else {
...
if (!function_exists('zapPurchases')) {
    function zapPurchases($tables = array())
    {
        ...
        if ($CI->db->table_exists('purchase_master')) {
            $res[] = $CI->db->truncate('purchase_master');
        }
        if ($CI->db->table_exists('purchase_product_master')) {
            $res[] = $CI->db->truncate('purchase_product_master');
        }
        if (in_array(FALSE, $res)) {
            set_flash_message('message', 'danger', "Something went Wrong");
        } else {
...
if (!function_exists('zapHistCost')) {
    function zapHistCost($tables = array())
    {
        ...
        if ($CI->db->table_exists('histcost_master')) {
            $res[] = $CI->db->truncate('histcost_master');
        }
        if (in_array(FALSE, $res)) {
            set_flash_message('message', 'danger', "Something went Wrong");
        } else {
