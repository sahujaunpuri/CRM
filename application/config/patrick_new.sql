...
--
-- Host: localhost    Database: patrick_new
-- ------------------------------------------------------
...
INSERT INTO `billing_master` VALUES (1,'MC','12 MONTHS MAINTENANCE CONTRACT','SET','800',19,'YES','Service',1),(2,'TP.IAF','TRADPAC IAF WINDOWS 10','SET','4650',19,'YES','Product',1),(3,'PW PLUS','PAYWIN PLUS WINDOWS 10','SET','4500',19,'YES','Product',1),(4,'PATCH','PAYWIN 2018 IR8A PATCH FILE','SET','330',19,'YES','Product',1),(5,'MCR','MC RENEWAL','SET','1200',19,'YES','Service',1),(6,'IR8A','PATCH FILE','SET','500',19,'YES','',1);
...
INSERT INTO `company_profile` VALUES (1,'TOPFORM BUSINESS SYSTEMS PTE LTD','yy','uuuuuu','BLK 71, UBI ROAD 1 , #08-35 , SINGAPORE 408732','+65 7777888999','(+65)67024812','logo.png','AFN','test@test.com');
...
INSERT INTO `currency_master` VALUES (1,'SGD',1,'Singapore Dollar'),(2,'INR',47.14,'Indian Rupee'),(3,'AUD',0.929,' Australian Dollar'),(4,'HKD',5.73,' Hong Kong Dollar'),(6,'USD',0.735,'US Dollar '),(7,'MYR',3.11,'Malaysian Ringgit '),(8,'BBD',0.029,'Barbados Dollar '),(9,'IDR',194.572,'Indonesian Rupiah '),(10,'test_currency',900,'test_currency_descriptioin');
...
INSERT INTO `customer_master` VALUES (1,'2018N10001','NATHALIN SHIPPING PTE LTD','6 TAMASEK BLVD','SUNTEC TOWER FOUR, #32-03 ','SINGAPORE  038986','63610382 / 99885324','63610377','nathalin@singnet.com.sg','MS MAGGIE CHING',50000.00,50000,1,'201055863k','201055863k',1.0,7,NULL,'C'),(2,'2018E10001','ELID TECHNOLOGY INTERNATIONAL PTE LTD','BLK 996 ','BENDEMEER ROAD #06-09','339944','62952218 / HP 88652516','62952282','SALES@ELIDTECH.COM.SG','MS LENY  MS PATRICIA',1500000.00,60,1,'','',2.0,7,NULL,'C'),(3,'2018M10001','MEGARIG HEAVY LIFT SERVICES PTE LTD','32 ','TUAS WEST AVENUE','638439','62687863','61189523','admin@megarig.com.sg','MS KAREN  MS HELNI',30.00,5000,1,'199852632H','199852632H',9.9,7,NULL,'C'),(4,'2018I20001','IDEMITSU LUBE ASIA PACIFIC PTE LTD','31 INTERNATIONAL BUSINESS PARK','CREATIVE RESOURCES #05-03','609921','66970550 / 66970556','66970599','ADMIN@IDEMITSU.COM.SG','MR TAEKI ',5000.00,30,1,'197803455K','197803455K',2.0,7,NULL,'C'),(5,'2018I20001','IDEMITSU LUBE SINGAPORE PTE LTD','31 INTERNATIONAL BUSINESS PARK','CREATIVE RESOURCES #05-03-04','609921','66970550 / 66970556','66970599','admin@idemitsu.com.sg','MS THAM  MR TAEKI TAN',5000.00,120,1,'198685226B','198685226B',8.0,7,NULL,'C'),(6,'2018GS000017','GS LOGISTIC SERVICES','BLOCK 972','HOUGANG STREET 91 #07-192','SINGAPORE 530972','64812550','64817709','gslog@singnet.com.sg','MS JASMINE TEH',50000.00,30,1,'GS20060011','GS20060011',7.0,7,NULL,'C'),(8,'2018ALLP0002','ASHURST LLP','12','MARINA BOULEVARD','018982','64160299','62215484','Annie.Tan@ashurst.com','MS ANNIE TAN',50000.00,30,1,'T07LL157G','T07LL1574G',5.0,7,NULL,'C'),(10,'2018D0100021','DRUMMOND PRINTING PTE LTD','YI XIU FACTORY BUILDING','65 SIM AVENUE #02-06','187418','6250300','62564924','selene@drummond.com','MS SELENE LYU',50000.00,30,1,'199005000K','199005000K',6.0,7,NULL,'C');
...
INSERT INTO `invoice_master` VALUES (1,'INV123.999231',4,1,'',2,800.00,0.00,800.00,7.00,856.00,1.00,856.00,'C.O.D.','Topform Trg Ctr',NULL,NULL,'All overdue accounts is chargeable for interest @ 1% per mensum','C','2018-01-17','2018-01-17',NULL,0,NULL,NULL),(2,'INV123.999232',5,1,'',2,800.00,0.00,800.00,7.00,856.00,1.00,856.00,'C.O.D.','Topform Trg Ctr',NULL,NULL,'All overdue accounts is chargeable for interest @ 1% per mensum','C','2018-01-17','2018-01-17',NULL,0,NULL,NULL),(3,'INV123.999233',6,2,'',2,1200.00,50.00,600.00,7.00,642.00,1.00,642.00,'C.O.D.','Topform Trg Ctr',NULL,NULL,'All overdue accounts is chargeable for interest @ 1% per mensum','C','2018-01-17','2018-01-17',NULL,0,NULL,NULL),(4,'INV123.999234',8,2,'',2,600.00,0.00,600.00,7.00,642.00,1.00,642.00,'C.O.D.','Topform Trg Ctr',NULL,NULL,'All overdue accounts is chargeable for interest @ 1% per mensum','D','2018-01-17','2018-01-17',NULL,0,NULL,NULL),(5,'INV123.999235',8,2,'',2,600.00,0.00,600.00,7.00,642.00,1.00,642.00,'C.O.D.','Topform Trg Ctr',NULL,NULL,'All overdue accounts is chargeable for interest @ 1% per mensum','C','2018-01-17','2018-01-17',NULL,0,NULL,NULL);
...
INSERT INTO `invoice_product_master` VALUES (1,1,1,1,0.00,800.00,800.00,19,'2018-01-17','2018-01-17'),(2,2,1,1,0.00,800.00,800.00,19,'2018-01-17','2018-01-17'),(3,3,5,1,0.00,1200.00,1200.00,19,'2018-01-17','2018-01-17'),(4,4,5,1,0.00,1200.00,600.00,19,'2018-01-17','2018-01-17'),(5,5,5,1,0.00,1200.00,600.00,19,'2018-01-17','2018-01-17');
...
--
-- Dumping data for table `m_create`
--

LOCK TABLES `m_create` WRITE;
/*!40000 ALTER TABLE `m_create` DISABLE KEYS */;
INSERT INTO `m_create` VALUES (1,'IDR',10002,'Indian Rupee'),(3,'USD222',0.7,'US dollar');
/*!40000 ALTER TABLE `m_create` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `other_payment` VALUES (1,'2017-12-20','Paymen.66832','5555',6,11111111.00,'2017-12-20',2,'C'),(8,'2017-12-20','Paymen.66835','test_payee_name  ',5,500.00,'2017-12-20',2,'D'),(3,'2017-12-20','Paymen.66833','test_payee_name  ',6,31044.00,'2017-12-20',2,'D'),(4,'2017-12-20','Paymen.66833','test_payee_name  ',4,4777.00,'2017-12-20',2,'D'),(5,'2017-12-20','Paymen.66833','ppppppp',2,500.00,'2017-12-20',2,'C'),(6,'2017-12-20','Paymen.66833','test_payee_name  ',10,400.00,'2017-12-20',2,'C'),(7,'2017-12-20','Paymen.66834','test_payee_name  ',18,120.00,'2017-12-20',2,'P'),(11,'2017-12-22','Paymen.66837','test_payee_name',7,100.00,'2017-12-22',2,'C'),(9,'2017-12-20','Paymen.66836','pppp ',6,7777.00,'2017-12-20',2,'P'),(10,'2017-12-20','Paymen.66836','pppp  ',4,6666.00,'2017-12-20',2,'C'),(12,'2017-12-22','Paymen.66838','oooooooooo',6,500.00,'2017-12-22',2,'C'),(13,'2017-12-27','Paymen.66839','',8,100.00,'2017-12-27',2,'D'),(14,'2017-12-27','Paymen.66839','',2,200.00,'2017-12-27',2,'D'),(15,'2017-12-27','Paymen.66839','',7,400.00,'2017-12-27',2,'D'),(16,'2017-12-27','Paymen.66840','rrrr',7,100.00,'2017-12-27',2,'C'),(17,'2017-12-27','Paymen.66841','test_payee_new',7,1000.00,'2017-12-27',2,'C'),(18,'2017-12-27','Paymen.66842','66666666666666666666666',6,400.00,'2017-12-27',2,'C'),(19,'2017-12-27','Paymen.66842','66666666666666666666666',29,500.00,'2017-12-27',2,'C'),(20,'2017-12-27','Paymen.66842','66666666666666666666666',4,77.00,'2017-12-27',2,'C');
...
INSERT INTO `payment_setting` VALUES (4,2,'Paymen','66842','','','','','','',''),(5,7,'Paymen','66827','','','','','','',''),(6,8,'Paymen','66827','','','','','','',''),(7,10,'Paymen','66827','','','','','','',''),(8,11,'Paymen','66827','','','','','','',''),(9,12,'Paymen','66827','','','','','','',''),(10,5,'Paymen','66827','','','','','','','');
...
INSERT INTO `quotation_master` VALUES (1,'TOP18.200004',4,1,'Based on the broad guidelines given to us, we are pleased to quote as follows : demo  text End',2,0.00,0.00,0.00,7.00,0.00,1.00,0.00,'5 days Overdue will be charged 3% of Total Payment','TRADPAC Training Centre','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','CONFIRM','2018-01-16','2018-01-16',0),(2,'TOP18.200005',3,1,'Based on the broad guidelines given to us, we are pleased to quote as follows : demo  text End',2,600.00,0.00,600.00,7.00,642.00,1.00,642.00,'5 days Overdue will be charged 3% of Total Payment','TRADPAC Training Centre','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','CONFIRM','2018-01-17','2018-01-17',0),(3,'TOP18.200006',6,1,'Based on the broad guidelines given to us, we are pleased to quote as follows : demo  text End',2,8900.00,0.00,8900.00,7.00,9523.00,1.00,9523.00,'5 days Overdue will be charged 3% of Total Payment','TRADPAC Training Centre','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','CONFIRM','2018-01-17','2018-01-17',0),(4,'TOP18.200007',10,2,'Based on the broad guidelines given to us, we are pleased to quote as follows : demo  text End',2,500.00,10.00,450.00,7.00,481.50,1.00,481.50,'5 days Overdue will be charged 3% of Total Payment','TRADPAC Training Centre','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','PENDING','2018-01-17','2018-01-17',0),(5,'TOP18.200008',10,2,'Based on the broad guidelines given to us, we are pleased to quote as follows : demo  text End',2,500.00,10.00,450.00,7.00,481.50,1.00,481.50,'5 days Overdue will be charged 3% of Total Payment','TRADPAC Training Centre','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','PENDING','2018-01-17','2018-01-17',0),(6,'TOP18.200009',10,2,'Based on the broad guidelines given to us, we are pleased to quote as follows : demo  text End',2,500.00,10.00,450.00,7.00,481.50,1.00,481.50,'5 days Overdue will be charged 3% of Total Payment','TRADPAC Training Centre','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','SUCCESSFUL','2018-01-17','2018-01-17',0);
...
INSERT INTO `quotation_product_master` VALUES (2,2,1,1,0.00,800.00,600.00,19,'2018-01-17','2018-01-17'),(4,3,3,2,10.00,4500.00,8100.00,19,'2018-01-17','2018-01-17'),(5,3,1,1,0.00,800.00,800.00,19,'2018-01-17','2018-01-17'),(6,4,6,1,0.00,500.00,500.00,19,'2018-01-17','2018-01-17'),(7,5,6,1,0.00,500.00,500.00,19,'2018-01-17','2018-01-17'),(8,6,6,1,0.00,500.00,500.00,19,'2018-01-17','2018-01-17');
...
INSERT INTO `salesman_master` VALUES (1,'Jen001','Jennifer Lee','SYS',''),(2,'Lily101','Lily Tan','MC','');
...
INSERT INTO `stock_invoice_master` VALUES (1,5,1,1,0.00,350.00,350.00,1,'2017-12-25','2017-12-25'),(2,18,1,1,0.00,350.00,350.00,1,'2017-12-26','2017-12-26'),(3,19,1,1,0.00,350.00,350.00,1,'2017-12-26','2017-12-26'),(4,19,2,1,0.00,900.00,900.00,1,'2017-12-26','2017-12-26'),(5,19,3,1,0.00,1200.00,1200.00,1,'2017-12-26','2017-12-26'),(6,20,1,1,0.00,350.00,350.00,1,'2017-12-26','2017-12-26'),(7,20,3,1,0.00,1200.00,1200.00,1,'2017-12-26','2017-12-26'),(8,20,2,1,0.00,900.00,900.00,1,'2017-12-26','2017-12-26'),(9,21,3,1,0.00,1200.00,1200.00,1,'2017-12-26','2017-12-26'),(10,22,1,1,0.00,350.00,350.00,1,'2017-12-26','2017-12-26'),(11,1,1,1,0.00,350.00,350.00,1,'2017-12-30','2017-12-30'),(12,1,1,1,0.00,800.00,800.00,19,'2018-01-17','2018-01-17'),(13,2,1,1,0.00,800.00,800.00,19,'2018-01-17','2018-01-17'),(14,3,5,1,0.00,1200.00,1200.00,19,'2018-01-17','2018-01-17'),(15,4,5,1,0.00,1200.00,600.00,19,'2018-01-17','2018-01-17'),(16,5,5,1,0.00,1200.00,600.00,19,'2018-01-17','2018-01-17');
